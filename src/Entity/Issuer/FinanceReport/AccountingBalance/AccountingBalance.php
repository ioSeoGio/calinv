    ...
    private function financialAttributes(): array
    {
        return [
            'ДОЛГОСРОЧНЫЕ АКТИВЫ' => [
                ...
                '_120' => 'Нематериальные активы',
                '_130' => 'Доходные вложения в материальные активы:',
                '_131' => 'в том числе: инвестиционная недвижимость',
                '_140' => 'Вложения в долгосрочные активы',
                '_150' => 'Долгосрочные финансовые вложения',
                '_160' => 'Вложения в долгосрочные активы',
                '_170' => 'Долгосрочная дебиторская задолженность',
                '_180' => 'Прочие долгосрочные активы',
                '_190' => 'Долгосрочные активы, т.р.',
            ],

            'КРАТКОСРОЧНЫЕ АКТИВЫ' => [
                '_210' => 'Запасы:',
                '_211' => 'в том числе: материалы',
                '_213' => 'в том числе: незавершенное производство',
                '_214' => 'в том числе: готовая продукция и товары',
                '_215' => 'в том числе: товары отгруженные',
                '_230' => 'Расходы будущих периодов',
                '_240' => 'НДС по приобретенным товарам, работам, услугам',
                '_250' => 'Краткосрочная дебиторская задолженность',
                '_260' => 'Краткосрочные финансовые вложения',
                '_270' => 'Денежные средства и эквиваленты',
                '_280' => 'Прочие краткосрочные активы',
                '_290' => 'Краткосрочные активы, т.р.',
            ],

            'КАПИТАЛ' => [
                '_410' => 'Уставный капитал',
                '_440' => 'Резервный капитал',
                '_450' => 'Добавочный капитал',
                '_460' => 'Нераспределенная прибыль (непокрытый убыток)',
                '_490' => 'Капитал, т.р.',
            ],

            'ДОЛГОСРОЧНЫЕ ОБЯЗАТЕЛЬСТВА' => [
                '_510' => 'Долгосрочные кредиты и займы',
                '_540' => 'Доходы будущих периодов',
                '_590' => 'Долгосрочные долги, т.р.',
            ],

            'КРАТКОСРОЧНЫЕ ОБЯЗАТЕЛЬСТВА' => [
                '_610' => 'Краткосрочные кредиты и займы',
                '_620' => 'Краткосрочная часть долгосрочных обязательств',
                '_630' => 'Краткосрочная кредиторская задолженность',
                '_631' => 'в том числе: поставщикам, подрядчикам, исполнителям',
                '_632' => 'в том числе: по авансам полученным',
                '_633' => 'в том числе: по налогам и сборам',
                '_634' => 'в том числе: по социальному страхованию и обеспечению',
                '_635' => 'в том числе: по оплате труда',
                '_636' => 'в том числе: по лизинговым платежам',
                '_637' => 'в том числе: собственнику имущества (учредителям, участникам)',
                '_638' => 'в том числе: прочим кредиторам',
                '_650' => 'Доходы будущих периодов',
                '_670' => 'Прочие краткосрочные обязательства',
