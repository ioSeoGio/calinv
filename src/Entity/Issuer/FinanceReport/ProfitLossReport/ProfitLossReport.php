    ...
    private function financialAttributes(): array
    {
        return [
            'ОСНОВНАЯ ДЕЯТЕЛЬНОСТЬ' => [
                ...
                '_020' => 'Себестоимость реализованной продукции, товаров, работ, услуг',
                '_030' => 'Валовая прибыль',
                '_040' => 'Управленческие расходы',
                '_050' => 'Расходы на реализацию',
                '_060' => 'Прибыль (убыток) от реализации продукции, товаров, работ, услуг',
                '_070' => 'Прочие доходы по текущей деятельности',
                '_080' => 'Прочие расходы по текущей деятельности',
                '_090' => 'Прибыль (убыток) от текущей деятельности',
            ],

            'ИНВЕСТИЦИОННАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_100' => 'Доходы по инвестиционной деятельности:',
                '_101' => 'В том числе: доходы от выбытия основных средств, нематериальных активов и других долгосрочных активов',
                '_102' => 'В том числе: доходы от участия в уставных капиталах других организаций',
                '_103' => 'В том числе: проценты к получению',
                '_104' => 'В том числе: прочие доходы по инвестиционной деятельности',

                '_110' => 'Расходы по инвестиционной деятельности',
                '_111' => 'В том числе: расходы от выбытия основных средств, нематериальных активов',
                '_112' => 'В том числе: прочие расходы по инвестиционной деятельности',
            ],

            'ФИНАНСОВАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_120' => 'Доходы по финансовой деятельности',
                '_121' => 'В том числе: курсовые разницы от пересчета активов и обязательств',
                '_122' => 'В том числе: прочие доходы по финансовой деятельности',

                '_130' => 'Расходы по финансовой деятельности',
                '_131' => 'В том числе: проценты к уплате',
                '_132' => 'В том числе: курсовые разницы от пересчета активов и обязательств',
                '_133' => 'В том числе: прочие расходы по финансовой деятельности',
            ],

            'ИТОГО' => [
                '_140' => 'Прибыль (убыток) от инвестиционной, финансовой и иной деятельности',
                '_150' => 'Прибыль (убыток) до налогообложения',
                '_160' => 'Налог на прибыль',
                '_170' => 'Изменение отложенных налоговых активов',
                '_180' => 'Изменение отложенных налоговых обязательств',
                '_190' => 'Прочие налоги и сборы, исчисляемые из прибыли (дохода)',

                '_210' => 'Чистая прибыль (убыток)',
                '_220' => 'Результат от переоценки долгосрочных активов, не включаемый в чистую прибыль (убыток)',
                '_230' => 'Результат от прочих операций, не включаемый в чистую прибыль (убыток)',
