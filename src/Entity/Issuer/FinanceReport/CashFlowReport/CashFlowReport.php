...
class CashFlowReport extends ApiFetchedActiveRecord implements FinancialReportInterface
{
    ...
    private function financialAttributes(): array
    {
        return [
            'ТЕКУЩАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_020' => 'Поступило по текущей деятельности (всего), т.р.',
                '_021' => 'в том числе: от покупателей продукции, товаров, заказчиков работ, услуг, т.р.',
                '_022' => 'в том числе: от покупателей материалов и других запасов, т.р.',
                '_023' => 'в том числе: роялти, т.р.',
                '_024' => 'в том числе: прочие поступления, т.р.',

                '_030' => 'Направлено по текущей деятельности (всего), т.р.',
                '_031' => 'в том числе: на приобретение запасов, работ, услуг, т.р.',
                '_032' => 'в том числе: на оплату труда, т.р.',
                '_033' => 'в том числе: на прочие выплаты, т.р.',
                '_040' => 'Результат ДДС по текущей деятельности, т.р.',
            ],

            'ИНВЕСТИЦИОННАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_050' => 'Поступило по инвестиционной деятельности (всего), т.р.',
                '_051' => 'в том числе: от покупателей основных средств, нематериальных активов и других долгосрочных активов, т.р.',
                '_052' => 'в том числе: возврат предоставленных займов, т.р.',
                '_053' => 'в том числе: доходы от участия в уставных капиталах других организаций, т.р.',
                '_054' => 'в том числе: проценты, т.р.',
                '_055' => 'в том числе: прочие поступления, т.р.',

                '_060' => 'Направлено по инвестиционной деятельности (всего), т.р.',
                '_061' => 'в том числе: на приобретение и создание основных средств, нематериальных активов и других долгосрочных активов, т.р.',
                '_062' => 'в том числе: на предоставление займов, т.р.',
                '_063' => 'в том числе: на вклады в уставные капиталы других организаций, т.р.',
                '_064' => 'в том числе: прочие выплаты, т.р.',
                '_070' => 'Результат ДДС по инвестиционной деятельности, т.р.',
            ],

            'ФИНАНСОВАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_080' => 'Поступило по финансовой деятельности (всего), т.р.',
                '_081' => 'в том числе: кредиты и займы, т.р.',
                '_082' => 'в том числе: от выпуска акций, т.р.',
                '_083' => 'в том числе: вклады собственника имущества (учредителей, участников), т.р.',
                '_084' => 'в том числе: прочие поступления, т.р.',

                '_090' => 'Направлено по финансовой деятельности (всего), т.р.',
                '_091' => 'в том числе: на погашение кредитов и займов, т.р.',
                '_092' => 'в том числе: на выплаты дивидендов и других доходов от участия в уставном капитале организации, т.р.',
                '_093' => 'в том числе: на выплаты процентов, т.р.',
                '_094' => 'в том числе: на лизинговые платежи, т.р.',
                '_095' => 'в том числе: прочие выплаты, т.р.',
                '_100' => 'Результат ДДС по финансовой деятельности, т.р.',
            ],

            'ИТОГО' => [
                '_110' => 'Результат ДДС по текущей, инвестиционной и финансовой, т.р.',
                '_120' => 'Остаток ДС на 31.12 позапрошлого года, т.р.',
                '_130' => 'Остаток ДС на 31.12 прошлого года, т.р.',
                '_140' => 'Влияние изменений курсов иностранных валют, т.р.',
            ],
        ];
    }
