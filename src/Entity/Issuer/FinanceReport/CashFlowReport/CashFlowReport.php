    ...
    private function financialAttributes(): array
    {
        return [
            'ТЕКУЩАЯ ДЕЯТЕЛЬНОСТЬ' => [
                ...
                '_021' => 'в том числе: от покупателей продукции, товаров, заказчиков работ, услуг',
                '_022' => 'в том числе: от покупателей материалов и других запасов',
                '_023' => 'в том числе: роялти',
                '_024' => 'в том числе: прочие поступления',

                '_030' => 'Направлено по текущей деятельности (всего)',
                '_031' => 'в том числе: на приобретение запасов, работ, услуг',
                '_032' => 'в том числе: на оплату труда',
                '_033' => 'в том числе: на прочие выплаты',
                '_040' => 'Результат ДДС по текущей деятельности',
            ],

            'ИНВЕСТИЦИОННАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_050' => 'Поступило по инвестиционной деятельности (всего)',
                '_051' => 'в том числе: от покупателей основных средств, нематериальных активов и других долгосрочных активов',
                '_052' => 'в том числе: возврат предоставленных займов',
                '_053' => 'в том числе: доходы от участия в уставных капиталах других организаций',
                '_054' => 'в том числе: проценты',
                '_055' => 'в том числе: прочие поступления',

                '_060' => 'Направлено по инвестиционной деятельности (всего)',
                '_061' => 'в том числе: на приобретение и создание основных средств, нематериальных активов и других долгосрочных активов',
                '_062' => 'в том числе: на предоставление займов',
                '_063' => 'в том числе: на вклады в уставные капиталы других организаций',
                '_064' => 'в том числе: прочие выплаты',
                '_070' => 'Результат ДДС по инвестиционной деятельности',
            ],

            'ФИНАНСОВАЯ ДЕЯТЕЛЬНОСТЬ' => [
                '_080' => 'Поступило по финансовой деятельности (всего)',
                '_081' => 'в том числе: кредиты и займы',
                '_082' => 'в том числе: от выпуска акций',
                '_083' => 'в том числе: вклады собственника имущества (учредителей, участников)',
                '_084' => 'в том числе: прочие поступления',

                '_090' => 'Направлено по финансовой деятельности (всего)',
                '_091' => 'в том числе: на погашение кредитов и займов',
                '_092' => 'в том числе: на выплаты дивидендов и других доходов от участия в уставном капитале организации',
                '_093' => 'в том числе: на выплаты процентов',
                '_094' => 'в том числе: на лизинговые платежи',
                '_095' => 'в том числе: прочие выплаты',
                '_100' => 'Результат ДДС по финансовой деятельности',
            ],

            'ИТОГО' => [
                '_110' => 'Результат ДДС по текущей, инвестиционной и финансовой',
                '_120' => 'Остаток ДС на 31.12 позапрошлого года',
                '_130' => 'Остаток ДС на 31.12 прошлого года',
                '_140' => 'Влияние изменений курсов иностранных валют',
            ],
        ];
    }
