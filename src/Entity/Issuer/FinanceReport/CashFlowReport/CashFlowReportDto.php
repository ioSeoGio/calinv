...
class CashFlowReportDto
{
    ...
    public static function fromApiCurrentYear(FinanceReportCashFlowDto $dto): self
    {
        return new self(
            ...
            _083: $dto->_083,
            _084: $dto->_084,
            _090: $dto->_090 !== null ? $dto->_090 : 0,
            _091: $dto->_091,
            _092: $dto->_092,
            _093: $dto->_093,
            _094: $dto->_094,
            _095: $dto->_095,
            _100: $dto->_100 !== null ? $dto->_100 : 0,
            _110: $dto->_110,
            _120: $dto->_120,
            _130: $dto->_130,
            _140: $dto->_140,
    ...
    public static function fromApiLastYear(FinanceReportCashFlowDto $dto): self
    {
        return new self(
            ...
            _064: $dto->last_064,
            _070: $dto->last_070,
            _080: $dto->last_080 !== null ? $dto->last_080 : 0,
            _081: $dto->last_081,
            _082: $dto->last_082,
            _083: $dto->last_083,
            _084: $dto->last_084,
            _090: $dto->last_090 !== null ? $dto->last_090 : 0,
            _091: $dto->last_091,
            _092: $dto->last_092,
            _093: $dto->last_093,
            _094: $dto->last_094,
            _095: $dto->last_095,
            _100: $dto->last_100 !== null ? $dto->last_100 : 0,
            _110: $dto->last_110,
            _120: $dto->last_120,
            _130: $dto->last_130,
            _140: $dto->last_140,
