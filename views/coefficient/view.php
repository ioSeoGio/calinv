    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'description' => 'Этот показатель характеризует прибыль, получаемую предприятием с каждого рубля, потраченного на формирование активов. Значения этого показателя имеет смысл сопоставлять только между предприятиями одной отрасли, при план-факторном анализе деятельности компании или при анализе изменения значения показателя во времени.',
                'format' => 'raw',
                'value' => function (Issuer $model) {
